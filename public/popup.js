document.addEventListener("DOMContentLoaded", function () {
    ...
    const addManualBlacklistButton = document.getElementById("addManualBlacklist");
    ...
    saveButton.addEventListener("click", function () {
        ...
        chrome.storage.local.set(
            { host: host, token: token, enabled: enabled },
            function () {
